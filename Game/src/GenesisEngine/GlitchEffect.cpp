...
/**
 * @brief Construct a new Glitch Effect:: Glitch Effect object
 * 
 * @param l_screenWidth 
 * @param l_screenHeight 
 * @param l_shader_ptr 
 */
GlitchEffect::GlitchEffect(uint32_t l_screenWidth, uint32_t l_screenHeight, TResourceShader * l_shader_ptr, const std::string& l_ID) : IEffect(l_shader_ptr, l_ID)
{
 ...
 * @param l_screenHeight 
 */
void GlitchEffect::Init(uint32_t l_screenWidth, uint32_t l_screenHeight)
{
    ...
    {
        //std::cout << "ERROR::GLITCH::FRAMEBUFFER:: Framebuffer is not complete!" << std::endl;
    }
    else
    {
        //std::cout << "SUCCESS::GLITCH::FRAMEBUFFER:: Framebuffer complete!" << std::endl;
    }
...
/**
 * @brief Destroy the Glitch Effect:: Glitch Effect object
 * 
 */
 ...
 * @param dt 
 */
void GlitchEffect::Draw(float dt)
{
    /**

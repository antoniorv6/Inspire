...
{
public:
    ShieldEffect(uint32_t l_screenWidth, uint32_t l_screenHeight, TResourceShader * l_shader_ptr, const std::string& l_ID);
...
private:
    ...
    TResourceTexture * m_blendingTexture       = nullptr;
};
...
class LeftShoulderFuzzySet : public IFuzzySet
{
private:
...
public:
    ...
    LeftShoulderFuzzySet(double l_peakPoint_d, double l_leftOffset_d, double l_rightOffset_d) : IFuzzySet( ((l_peakPoint_d - l_leftOffset_d) + l_peakPoint_d) / 2 ),
                                                                                                m_peakPoint_d(l_peakPoint_d),
                                                                                                m_leftOffset_d(l_leftOffset_d),
                                                                                                m_rightOffset_d(l_rightOffset_d){};
    virtual ~LeftShoulderFuzzySet(){};
